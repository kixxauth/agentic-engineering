...
> The logger coupling could be cleaner
...
> **Logger writer injection** (#2) — Small, contained change. Once you've established the pattern of injecting platform primitives like we did with the EventEmitter, applying the same pattern to the logger writer is straightforward and reinforces the approach.
